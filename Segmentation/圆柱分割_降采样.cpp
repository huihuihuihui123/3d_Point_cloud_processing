...
Description:用于圆柱点云的分割，主要包括点云降采样、滤除平面、欧式距离分割、保存分割点云等功能

首先运行主函数1，降采样、滤除平面，保存滤除平面后的点云
其后运行主函数2，进行点云分割，保存分割后的点云数据
**************************************************/
...
/*-------------------------主函数1，首先进行平面分割，保存滤除平面后的点云cloud_down_sample.pcd-----------------------------------*/
#if 0
//*********************平面分割*********************************/
...
#endif
/*-------------------------主函数2，读取滤除平面后的点云cloud_down_sample.pcd，保存分割后的点云-----------------------------------*/
#if 1
int
